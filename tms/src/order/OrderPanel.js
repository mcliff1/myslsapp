/**
 * @file OrderPanel.js
 * 'dumb' REACT component for detail Order information
 */
...
const InnerOrderPanel = ({ info, isNew, touched, errors, handleClose, handleDelete }) =>
(
      <div>
        <Form>
          <FormGroup row>
...
const OrderPanel = withFormik({
  ...
  displayName: 'OrderPanel', // helps with React DevTools
})(InnerOrderPanel)
